...
const chatResponses = {
  ...
  amdox: "At Amdox Technologies (Jan 2026 – Jun 2026), Mansi supported senior team members on NeuralRetail, an enterprise retail analytics system, by developing 3 ML models under guided workflows — XGBoost churn classification (0.84+ ROC-AUC), ARIMA 30-day demand forecasting, and K-Means customer segmentation. She built and tested secure RESTful FastAPI endpoints with JWT authentication and SQLite persistence, performed exploratory data analysis with a Streamlit/Plotly dashboard, and tracked model lifecycle metrics in MLflow.",
  pune: "Yes, Mansi Patil is based in Pune, India, and is open to entry-level Data Scientist, AI/ML Engineer, and Python Development roles.",
  tech: "Her updated skillset covers:<br>• BI, Analytics & Data: Power BI, SQL, Python, PySpark, Pandas, NumPy, Feature Engineering, Data Cleansing & Validation, Exploratory Data Analysis, Matplotlib/Seaborn<br>• Machine Learning: Scikit-learn, XGBoost, PyTorch, Regression, Classification, Clustering, Forecasting, Model Evaluation & Cross-Validation, OpenCV, YOLO<br>• Generative AI / LLM: LLM Integration, Prompt Engineering, RAG, Multimodal RAG, Embeddings, Vector Databases (Qdrant), Cross-Modal Retrieval, LangChain, LangGraph, OpenAI GPT, Claude, Gemini, Groq API, Hugging Face, Natural Language Processing (NLP)<br>• Backend, APIs & Databases: FastAPI, Django, REST APIs, MySQL, PostgreSQL, SQLite<br>• Tools & Workflow: Docker, Git/GitHub, GitHub Actions, MLflow (experiment tracking), Jupyter, Streamlit, Postman, AWS",
  jobs: "Yes! Mansi is a Computer Science graduate (B.Tech CSE, CGPA 8.74/10) with hands-on experience across Data Analytics, Machine Learning, and Generative AI. She is actively seeking entry-level Data Scientist and AI/ML Engineer roles to support senior team members in building reliable models, dashboards, and AI-enabled solutions within structured, guided workflows.",
  ...
  resume: "You can view and download Mansi's PDF resume directly using the 'Download PDF' and 'View Resume' buttons in the Resume section of the site!",
...
function renderOpportunityForm() {
  ...
  return `
    <div>
      <p style="margin-bottom:0.6rem">Mansi is currently open to entry-level <b>Data Scientist</b>, <b>AI/ML Engineer</b>, and <b>Python Development</b> roles! Please submit your opportunity details below to connect or schedule an interview:</p>
